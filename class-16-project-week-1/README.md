...
1. Today, your team must submit a proposal to an instructor with the following information:
 ...
 **TIP:** Use pencil and paper to diagram and sketch.
  ...
  Everything (except the wireframes) must be written in your project's README file. They are due for review with the instruction team at noon.
...
Note: today through Wednesday you should be focusing on your web site's functionality. Don't style things beyond what's absolutely neccessary.g